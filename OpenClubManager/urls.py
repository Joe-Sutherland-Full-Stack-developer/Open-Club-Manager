...
urlpatterns = [
    ...
    path('class-instance/<int:pk>/edit/', dashboard_views.edit_class_instance, name='edit_class_instance'),
    path('class-instance/<int:pk>/delete/', dashboard_views.delete_class_instance, name='delete_class_instance'),
    ...
    path('delete-participant/', dashboard_views.delete_participant, name='delete_participant'),
    ...
    path('settings/', dashboard_views.settings_page, name='settings_page'),
]   
